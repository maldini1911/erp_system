...
class CreateFacebookCoustmerCampaignsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('facebook_coustmer_campaigns', function (Blueprint $table) {
            ...
            $table->integer('custom_budget')->nullable();
    ...
    {
        Schema::dropIfExists('facebook_coustmer_campaigns');
    }
}
