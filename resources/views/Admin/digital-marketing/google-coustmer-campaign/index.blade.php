            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{url('admin/google/coustmer/campaign/create')}}" class="btn btn-md btn-success float-left">Create</a>
                        ...
                        <div class="table-responsive">
                            <table id="example" class="table table-bordered">
                                ...
                                @if(auth()->user()->role == 'admin')
                                    ...
                                    <tr>
                                        <th>{{$row->id}}</th>
                                        <th> {{ $row->manageclient['client_name'] ? $row->manageclient['client_name'] : 'Null' }}</th>
                                        ...
                                        <th>
                                            <a href="{{url('admin/google/coustmer/campaign/'.$row->id)}}" class="btn btn-info btn-sm">{{trans('admin.show')}}</a>
                                            <a href="{{url('admin/google/coustmer/campaign/'.$row->id.'/edit')}}" class="btn btn-success btn-sm">{{trans('admin.edit')}}</a>
                                            <a href="{{url('admin/google/coustmer/campaign/delete/'.$row->id)}}" class="btn btn-danger btn-sm">{{trans('admin.delete')}}</a>
                                        </th>
                                    </tr>
                                    @endforeach
                                @endif
