            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{url('admin/google/coustmer/campaign')}}" method="POST" enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <!-- End -->
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error($input) is-invalid @enderror" id="input-21" placeholder="{{trans('admin.roi')}}" name="{{$input}}">
                                        @error($input)
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error($input) is-invalid @enderror" id="input-21" placeholder="{{trans('admin.clicks')}}" name="{{$input}}">
                                        @error($input)
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control @error($input) is-invalid @enderror" id="input-21" placeholder="{{trans('admin.ctr')}}" name="{{$input}}">
                                        @error($input)
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
