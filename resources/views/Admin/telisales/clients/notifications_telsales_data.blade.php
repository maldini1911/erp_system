...
<div class="profile-admin">
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body">
                    <i class="fa fa-bell-o text-red" style="color:#ff0000;font-weight:bolder;"></i>  All Notifiactions Telesales Data
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                <th>{{$notify->data['marketer']}}</th>
                                <th><a href="{{url('admin/clients/'.$notify->data['id_client_sales'])}}" class="btn btn-info"> Show New Client </a> </th>
                                <th>
                                    <a href="{{url('admin/notifcations/telesales/data/delete/'.$notify->data['id_client_sales'])}}" class="btn btn-danger">{{trans('delete')}}</a>
                                </th>
                            </tr>
                            @endforeach
                            </tbody>
