...
@push('css')
    <style>
        .show-clients tr td:first-child{width: 100px}
        .show-clients tr td:last-child{text-align: center}
    </style>
@endpush
...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
                ...
                <h4>All Projects</h4>
                <div class="small"></div>
                <h5>Total Paid Price : {{$total_price}} EGP </h5>
                <h5>Remaining Price : {{$total_remaining_price}} EGP </h5>
                <div class="small"></div>
