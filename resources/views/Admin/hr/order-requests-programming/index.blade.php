                                ...
                                @if(auth()->user()->role == 'admin')
                                    @foreach($rows as $row)
                                        <tr>
                                            ...
                                            @endif
                                            <th>
                                                <a href="{{url('admin/requests/programming/'.$row->id)}}" class="btn btn-info"> {{trans('admin.show')}}</a>
                                                <a href="{{url('admin/requests/programming/'.$row->id.'/edit')}}" class="btn btn-success"> {{trans('admin.edit')}}</a>
                                                <a href="{{url('admin/requests/programming/delete/'.$row->id)}}" class="btn btn-danger"> {{trans('admin.delete')}}</a>
                                            </th>
                                        </tr>
                                    @endforeach
                                @endif
