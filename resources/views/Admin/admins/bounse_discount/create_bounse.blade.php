        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form action="{{url('admin/admins/bounses/store')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="text" class="form-control @error($input) is-invalid @enderror" id="input-21" placeholder="Enter Your Bounse" name="{{$input}}">
                                @error($input)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="date" name="{{$input}}" class="form-control">
                                @error($input)
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
