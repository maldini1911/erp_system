...
@section('system')
    <div class="create-admin">
        <a href="{{url('admin/projects/programmers/'.$project_id)}}" class="btn btn-success"> All {{trans('admin.programmers')}}</a>
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{url('admin/projects/programmers/store')}}" method="POST">
                        ...
                        <!-- Start row -->
                            <div class="row">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <select class="form-control" id="multiple-select" name="{{$input}}" multiple="multiple">
